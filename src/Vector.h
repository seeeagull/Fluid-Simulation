...
public:
    ...
    Vector2f& operator *= (const Vector2f &v) { x *= v.x, y *= v.y; return *this; }
    Vector2f& operator *= (const float &r) { x *= r, y *= r; return *this; }
...
inline Vector2f lerp2(const Vector2f &a, const Vector2f& b, const float &t)
{ return a * (1 - t) + b * t; }

inline Vector3f lerp3(const Vector3f &a, const Vector3f& b, const float &t)
{ return a * (1 - t) + b * t; }
